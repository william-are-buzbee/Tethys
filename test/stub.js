...
class WebGLRenderer{constructor(){this.info={render:{calls:0,triangles:0}};this.shadowMap={enabled:false,type:0};this.rt=null;} setPixelRatio(){} setSize(){} getRenderTarget(){return this.rt;} setRenderTarget(t){this.rt=t;}
