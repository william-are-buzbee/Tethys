...
const FX_LIST=[['caustics','caustics'],['snell','snell window'],['refract','refraction'],['pixel','pixel light'],['texels','texels'],['texelLight','banded light'],['shadows','shadows'],['statics','world shadows'],['ground','ground shadows'],['sharp','sharp shadows'],['shafts','light shafts'],['snow','marine snow'],['rain','rain'],['clouds','clouds'],['blood','blood'],['vignette','vignette']];
const FX_DEF={caustics:true,cauK:1,pixel:false,texels:false,texelLight:true,shadows:Q.tier!=='low',statics:false,ground:false,sharp:false,shafts:true,snow:true,rain:true,clouds:true,blood:true,vignette:true,snell:false,refract:true,refrK:1}; // shadows: off on the low tier (a phone) until measured there; statics, ground (v11.30): the world's own shadows — the flora, rock and structures, and the terrain — off until measured (scene.js updateShadowS); sharp: both shadow maps at twice the size (scene.js shadowSize)
