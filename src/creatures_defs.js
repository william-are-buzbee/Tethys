...
const ROSTER=[
  ...
  {id:'rasp',clade:'ringmouths',family:'coilshells',niche:'floor grazer, shelled',floor:true,new:true},
  ...
  {id:'watcher',clade:'ringmouths',family:'crawlers',niche:'a curious omnivore',floor:true,new:true},
  {id:'pall',clade:'ringmouths',family:'the deep line',niche:'the dark\'s resident',new:true},
  ...
  {id:'darter',clade:'slowbloods',family:'finbacks',niche:'small forage (unspawned)'},
  {id:'needle',clade:'slowbloods',family:'finbacks',niche:'small-prey hunter, in threes',new:true},
  {id:'grazer',clade:'slowbloods',family:'finbacks',niche:'floor grazer, herds',floor:true},
  {id:'basker',clade:'slowbloods',family:'finbacks',niche:'mid predator, vent-bound',new:true},
  ...
  {id:'stone',clade:'slowbloods',family:'platebacks',niche:'floor ambush, torpid, bite',floor:true,new:true},
  {id:'crusher',clade:'slowbloods',family:'platebacks',niche:'shell-eater',new:true},
  {id:'scuttle',clade:'hingeshells',family:'walkers',niche:'floor grazer, walks on land',floor:true},
  {id:'trap',clade:'hingeshells',family:'walkers',niche:'floor ambush, strike',floor:true,new:true},
  {id:'hook',clade:'hingeshells',family:'walkers',niche:'structure hunter, climbs',new:true},
  {id:'tread',clade:'hingeshells',family:'walkers',niche:'sediment feeder, the giant',floor:true,new:true},
  {id:'picker',clade:'hingeshells',family:'walkers',niche:'scavenger at the rim of the dark',floor:true,new:true},
  {id:'flicker',clade:'hingeshells',family:'paddlers',niche:'small forage',new:true},
  ...
  {id:'comb',clade:'hingeshells',family:'paddlers',niche:'big filter feeder, the minor one',new:true},
  {id:'jelly',clade:'drifters',family:'bells',niche:'the pulser, the lit water'},
  {id:'deepbell',clade:'drifters',family:'bells',niche:'the giant of the drift, below the light',new:true},
  {id:'sailer',clade:'drifters',family:'floats',niche:'sails the surface, fishes with lines',new:true},
