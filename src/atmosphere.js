...
const REFL_FACET=1.0,REFL_GRAZE=[0.12,0.35]; // REFL_GRAZE: the cosine (of the view to the mean surface) below which the Fresnel weight is the mean surface's and above which it is the facet's — 7° to 20° of depression
...
const SURF_MAT=(function(){
  ...
  m.onBeforeCompile=function(sh){
    ...
    sh.fragmentShader='uniform float uTime;uniform float uAmp;uniform float uUnder;uniform vec3 uWin;uniform vec3 uGlint;uniform float uRain;uniform float uBody;uniform float uChop;uniform mat3 uFogR;varying float vH;varying vec2 vWp;varying vec3 vNup;varying float vBrk;float snell=1.0;float cv2=1.0;\n'+sh.fragmentShader
