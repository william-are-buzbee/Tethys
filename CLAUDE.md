...
| `PLANKTON.md` | the water's own life (22 Sep 2026; passes 1–2 built v11.81–82, the rest designed): the plankton field, its patches (windrows, the tidal front ring, the lee), the day's vertical migration, the year, the three pigment kinds as the water's colour, the bioluminescent bloom, the snow refined, the swarm tier, filter feeding, and the canopy ghost to strip; §15 the person's answers |
