...
| `test/player.js` | the player as a spec (v11.68): the three presets' numbers against CLADES' old literals, a non-preset spec on derive's, the spec through the save and a version 1 record as its preset | `node test/player.js`, `TIER=low …` |
