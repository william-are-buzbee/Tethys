...
| `test/sky.js` | the cloud field and the weather (v11.87, CLOUDS.md): the threshold table monotone, the cloud fraction equal to the cover asked for, no NaN over the world with the giant's cap, the beam's shadow in range; the year's clocks — showers ~8% and twice as likely before dawn as in the afternoon, the cirrus the still season's, calms a quarter, boot fair with a shower a few hours in; the lumps' scan (the pool, every lump measured, the caps); the costs | `node test/sky.js` |
...
| `CLOUDS.md` | the sky's clouds and the weather's clocks (24 Sep 2026; passes A–C and the lumps built v11.87, pass D — showers with a place — designed): what was there and what was artefact, what this planet's sky is by the day, the wave and the season, the giant's cap, the field written twice, the lumps' judgement for the person; §7 the person's answers |
